...
<body class="hold-transition login-page background_index">
    <div class="menu_principal" style="margin-top: -34em;">
        <div class="bt_menu m-left-0">
            <a href="https://kingrespectcrypto.com">
                Home Page
            </a>
        </div>
        <div class="bt_menu">
            <a href="https://kingrespectcrypto.com/playgame.php">
                Play Game
            </a>
        </div>
        <div class="bt_menu">
        ...
        <div class="bt_menu">
            <a href="https://kingrespectcrypto.com/presale.php">
                Pre sale
            </a>
        </div>
        <div class="bt_menu">
        ...
        <div class="bt_menu">
            <a href="https://kingrespectcrypto.com/contact.php">
                Contact
            </a>
        </div>
    </div>
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body" style="height: 4em;">
