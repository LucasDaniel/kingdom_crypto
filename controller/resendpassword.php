    ...
    if ((empty($_POST['g-recaptcha-response'])) && ($msg == "")) { 
        ...
        if (($result->success == 1) && ($msg == "")) {
            ...
            if ((mysqli_num_rows(mysqli_query($conn, $query)) > 0) && ($msg == "")) {
                ...
                if ($row['enabled'] != 0) $resendpassword = $row['enabled'];
                else {
                ...
                $arquivo = "
                    ...
                    <html>
                        <table width='510' border='1' cellpadding='1' cellspacing='1' bgcolor='#CCCCCC'>
                            ...
                            <tr>
                                <td width='320'>Use the code '<b>$resendpassword</b>' to activate your account</td>
                            </tr>
                            <tr>
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="row">
                    <?php if (($msg == "Email activated successfully. You can play now :D") || ($msg == "Account already registered!")) { ?> 
