    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <?php if (!$erro) { ?>
                    <form action="https://kingrespectcrypto.com/controller/catchfishaction.php" method="post">
                        ...
                        <div class="row m-top-12px">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block" name="submit" onclick="return valida()">Catch Fish</button>
                            </div>
                        </div>
                    </form>
