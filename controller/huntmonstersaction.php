        ...
        if ((mysqli_num_rows(mysqli_query($conn, $query)) > 0) && ($msg == "")) {
            ...
            if (mysqli_query($conn, $query)) {
                ...
                if (count($rowCharacter) > 0) {
                    ...
                    $query = "UPDATE servant SET app_code='$app_code', lives=2, multiplier='1.0', work_at='huntmonsters', recovery_energy='0000-00-00 00:00:00', work_init='$data', work_finish='$endWork' WHERE id_user = ".$id." AND id = ".$idCharacter."";
                    if (mysqli_query($conn, $query)) {
                        $msg = "Servant working..."; 
                        $erro = false;
                    } else {
