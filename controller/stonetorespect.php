                        ...
                        <div class="row m-top-12px">
                            <div class="col-12">
                                <select name="amounttorespect">
                                    <option value="1000stone">Convert 1000 stone to 1 Respect</option>
                                    <option value="2000stone">Convert 2000 stone to 2 Respect</option>
                                    <option value="5000stone">Convert 5000 stone to 5 Respect</option>
                                    <option value="10000stone">Convert 10000 stone to 10 Respect</option>
                                    <option value="20000stone">Convert 20000 stone to 20 Respect</option>
                                </select>
                            </div>
                        </div>                        
