        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <?php if (!$erro) { ?>
                    ...
                    <form action="https://kingrespectcrypto.com/controller/workwoodaction.php" method="post">
                        ...
                        <div class="row m-top-12px">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block" name="submit" onclick="return valida()">Cut wood</button>
                            </div>
                        </div>
                    </form>
